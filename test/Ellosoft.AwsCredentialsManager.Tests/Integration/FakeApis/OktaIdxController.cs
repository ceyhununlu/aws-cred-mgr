...
public class OktaIdxController : ControllerBase
{
    ...
    private static readonly ConcurrentDictionary<string, bool> RedirectIdpOffered = new();
    ...
    public IActionResult CancelPolling([FromBody] JsonElement request)
    {
        ...
        {
            if (OffersRedirectIdp(CorrelationId))
    ...
    public static void SetOffersRedirectIdp(string correlationId, bool offersRedirectIdp) => RedirectIdpOffered[correlationId] = offersRedirectIdp;
    ...
    private static bool OffersRedirectIdp(string correlationId) => RedirectIdpOffered.TryGetValue(correlationId, out var offered) && offered;
              ...
              "value": [
                {
                  ...
                  "href": "{{BaseUrl}}/sso/idps/0oa-fastpass",
                  "method": "GET"
                }
              ]
            }
