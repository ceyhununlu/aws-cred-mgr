...
public class OktaVerifyAppLauncherTests
{
    ...
    public void ExtractOktaVerifyDeepLink_WhenHtmlContainsCustomUri_ShouldReturnDeepLink()
    {
        ...
        OktaVerifyAppLauncher.ExtractOktaVerifyDeepLink(Html)
            .ShouldBe("com-okta-authenticator:/deviceChallenge?challengeRequest=eyJraWQ.jwt");
    }

    [Fact]
    public void ExtractOktaVerifyDeepLink_WhenContentIsNotAnOktaVerifyLink_ShouldReturnNull()
    {
        OktaVerifyAppLauncher.ExtractOktaVerifyDeepLink("https://xyz.okta.com/login").ShouldBeNull();
        OktaVerifyAppLauncher.ExtractOktaVerifyDeepLink("<html>no deep link</html>").ShouldBeNull();
        OktaVerifyAppLauncher.ExtractOktaVerifyDeepLink(null).ShouldBeNull();
    }
}
