...
public class OktaIdxAuthenticatorTests
{
    ...
    public OktaIdxAuthenticatorTests()
    {
        ...
        _authenticator = new OktaIdxAuthenticator(httpClientFactory, _challengeHandler, _appLauncher, _console, NullLogger<OktaIdxAuthenticator>.Instance);
    }
    ...
    public async Task AuthenticateAsync_WhenAuthorizePageHasNoStateToken_ShouldFallBackToOrgRootSignInPage()
    {
        ...
        var authenticator = new OktaIdxAuthenticator(httpClientFactory, _challengeHandler, _appLauncher, _console, NullLogger<OktaIdxAuthenticator>.Instance);
    ...
    [Fact]
    public async Task AuthenticateAsync_WhenRedirectIdpPointsOffTheOktaOrg_ShouldThrow()
    {
        _oktaHandler
            .OnJson(HttpMethod.Post, IntrospectUrl, IdxPayloads.IdentifyWithPassword)
            .OnJson(HttpMethod.Post, IdentifyUrl, IdxPayloads.ChallengePollLoopback);
        ...
        _challengeHandler
            .ExecuteAsync(Arg.Any<IdxClient>(), Arg.Any<Uri>(), Arg.Any<IdxResponse>(), Arg.Any<CancellationToken>())
            .Returns(IdxResponse.Parse(IdxPayloads.RedirectIdpExternal));
        ...
        _oktaHandler.RequestsTo(HttpMethod.Get, "https://accounts.google.com/o/oauth2/v2/auth?client_id=abc").ShouldBeEmpty();
    }
