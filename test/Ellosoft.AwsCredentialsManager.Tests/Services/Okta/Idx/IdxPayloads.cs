...
public static class IdxPayloads
{
    ...
    /// <summary>
    ///     Windows FastPass: after loopback is cancelled Okta offers <c>redirect-idp</c> instead of
    ///     <c>launch-authenticator</c>. The href stays on the Okta org and hands the challenge to Okta Verify.
    /// </summary>
    public const string RedirectIdpFastPass =
        """
        {
          "version": "1.0.0",
          "stateHandle": "02state-handle",
            ...
            "value": [
              {
                ...
                "name": "redirect-idp",
                "type": "OIDC",
                "idp": { "id": "0oa-fastpass", "name": "Okta FastPass" },
                "href": "https://xyz.okta.com/sso/idps/0oa-fastpass",
                "method": "GET"
              }
            ]
          }
    ...
    /// <summary>
    ///     Social / federated IdP redirect. The CLI must not follow this off the Okta org.
    /// </summary>
    public const string RedirectIdpExternal =
        """
        {
          "version": "1.0.0",
          "stateHandle": "02state-handle",
            ...
            "value": [
              {
                ...
                "name": "redirect-idp",
                "type": "OIDC",
                "idp": { "id": "0oa-google", "name": "Google" },
                "href": "https://accounts.google.com/o/oauth2/v2/auth?client_id=abc",
                "method": "GET"
              }
            ]
          }
